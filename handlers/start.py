...
@Client.on_message(filters.command(["mstart", "start@RawanaaMusicaBot"]) & filters.private & ~filters.channel)
async def start(_, message: Message):
    await message.reply_text(
        text="**Hello 👋🏻 {}!**\n\nI **Can Play Music In Voice Chats of Telegram Groups.**I Have A **lot of cool feature that will amaze You!**\n\n**Click /cmdlist For More Help On My Usage ❤**".format(message.from_user.mention),
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton("➕ Add To Your Group ➕", url="https://t.me/RawanaaMusicBot?startgroup=true")
            ],[
            InlineKeyboardButton("💬 Group", url="https://t.me/countdraculasupport"),
            InlineKeyboardButton("Channel 🔊", url="https://t.me/countdraculasupport")
            ],[
...
@Client.on_message(filters.command(["mstart", "start@RawanaaMusicBot"]) & ~filters.private & ~filters.channel)
async def gstart(_, message: Message):
    await message.reply_text(
        text="**Music Bot Is Online ✅**",
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/countdraculasupport")
            ]]
        )
    )


@Client.on_message(filters.command(["cmdlist", "start@RawanaaMusicBot"]) & filters.private & ~filters.channel)
...
• `/userbotleave` : __Assistant Leaves From The Group.__""",
        reply_markup=InlineKeyboardMarkup(
              [[
              InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/countdtaculasupport")
              ]]
          )
      )
